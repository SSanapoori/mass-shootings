...
To get the death percentage information, I created anew dataframe that only includes, state, num_hurt and num_killed and a new column that includes death rates (which are calculated using the information provided in the orginal dataset)
