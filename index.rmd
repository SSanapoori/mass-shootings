...
Looking at the above table it is clear that `r state_highest_casualty` has the highest number of deaths, injuries and casualties. 
...
To get the death percentage information, I created a new dataframe that only includes, state, num_hurt and num_killed and a new column that includes death rates (which are calculated using the information provided in the orginal dataset)
